...
public class MyController {
	...
	public String login(@RequestBody Auth_user user)
	{ 
	...
	public String loginUser(@RequestBody Auth_user user)
	{ 
	...
	public String addInMyCerti(@RequestParam("certi_name") String mycerti) 
	{
	...
	public String addInMyTrain(@RequestParam("training_name") String myTrain) 
	{
//		System.out.println("mycerti is available");
		//System.out.println(this.status.getUserid());
	...
	public String delInTrain(@RequestBody Enroll_Training myTrain) 
	{
